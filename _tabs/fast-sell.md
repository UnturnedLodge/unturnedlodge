...
## What is this?
**🎊🎉You can now sell items within your inventory with just a click!🎉🎊**  
*No more annoying `/sell` command!*
...
![Main game menu](/assets/img/tabs/fast-sell/menu_main.jpg)
_Main game menu_

Then open the *Controls* menu by clicking **Controls**:
![Controls menu](/assets/img/tabs/fast-sell/menu_controls.jpg)
_Controls menu_

Scroll down to the *Code Hotkey #1* and rebind it by clicking on it and press the new button to map.
